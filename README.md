...
[![Build Status](https://img.shields.io/github/actions/workflow/status/tuupola/ksuid/tests.yml?branch=2.x&style=flat-square)](https://github.com/tuupola/ksuid/actions)
